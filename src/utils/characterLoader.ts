...
import character3 from "../app/(with-layout)/farm/characters/character-3.json";
import character4 from "../app/(with-layout)/farm/characters/character-4.json";
...
import character7 from "../app/(with-layout)/farm/characters/character-3.json";
import character8 from "../app/(with-layout)/farm/characters/character-4.json";
