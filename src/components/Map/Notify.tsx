        ...
        >
          ...
          <defs>
            ...
            >
              ...
              <stop offset="0.374839" stopColor="#D98D93" />
              <stop offset="0.592469" stopColor="#9262EA" />
              <stop offset="0.78" stopColor="#4633C3" />
              <stop offset="1" stopColor="#162A4B" />
            </linearGradient>
            <linearGradient
            ...
            >
              <stop stopColor="#FBFBFB" />
              <stop offset="0.25" stopColor="#D98D93" />
              <stop offset="0.468842" stopColor="#9262EA" />
              <stop offset="0.78" stopColor="#4633C3" />
              <stop offset="0.975" stopColor="#162A4B" />
            </linearGradient>
            <linearGradient
            ...
            >
              <stop stopColor="#FBFBFB" />
              <stop offset="0.25" stopColor="#D98D93" />
              <stop offset="0.625" stopColor="#9262EA" />
              <stop offset="0.78" stopColor="#4633C3" />
              <stop offset="0.975" stopColor="#162A4B" />
            </linearGradient>
          </defs>
